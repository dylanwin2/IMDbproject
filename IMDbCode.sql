...
CREATE TABLE IF NOT EXISTS `sakila`.`film_actor` (
  ...
  CONSTRAINT `fk_film_actor_actor`
    ...
    REFERENCES `sakila`.`IMDb_actors` (`actor_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_film_actor_film`
    FOREIGN KEY (`film_id`)
    REFERENCES `sakila`.`IMDb_Movie_Lookup` (`IMDb_film_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sakila`.`IMDb_actors`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`IMDb_actors` ;

CREATE TABLE IF NOT EXISTS `sakila`.`IMDb_actors` (
...
-- -----------------------------------------------------
-- Table `sakila`.`IMDb_country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`IMDb_country` ;

CREATE TABLE IF NOT EXISTS `sakila`.`IMDb_country` (
  `IMDbcountry_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `country` VARCHAR(50) NOT NULL,
  `last_update` TIMESTAMP(1) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`IMDbcountry_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


-- -----------------------------------------------------
-- Table `sakila`.`IMDb_film_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`IMDb_film_category` ;

CREATE TABLE IF NOT EXISTS `sakila`.`IMDb_film_category` (
  `film_id` SMALLINT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `sakila`.`IMDb_Movie_Lookup`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`IMDb_Movie_Lookup` ;

CREATE TABLE IF NOT EXISTS `sakila`.`IMDb_Movie_Lookup` (
  `IMDb_film_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
  `description` TEXT NULL,
  `release_year` YEAR NULL,
  `language` TINYINT NOT NULL,
  `origin` TINYINT NULL DEFAULT NULL,
  `movie_duration` TINYINT NOT NULL DEFAULT 3,
  `movie_length` DECIMAL(4,2) NOT NULL DEFAULT 4.99,
  ...
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `USER_ID_IMDb_customer_id` SMALLINT UNSIGNED NOT NULL,
  INDEX `idx_title` (`title` ASC),
  INDEX `idx_fk_language_id` (`language` ASC),
  INDEX `idx_fk_original_language_id` (`origin` ASC),
  PRIMARY KEY (`IMDb_film_id`),
  INDEX `fk_film_USER_ID_IMDb1_idx` (`USER_ID_IMDb_customer_id` ASC),
  ...
  CONSTRAINT `fk_film_language_original`
    ...
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_film_USER_ID_IMDb1`
    FOREIGN KEY (`USER_ID_IMDb_customer_id`)
    REFERENCES `sakila`.`USER_ID_IMDb` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sakila`.`IMDb_User`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`IMDb_User` ;

CREATE TABLE IF NOT EXISTS `sakila`.`IMDb_User` (
  `idIMDb_UserID` SMALLINT NOT NULL,
  `First_Name` VARCHAR(1) NOT NULL,
  `Last_Name` VARCHAR(45) NOT NULL,
  `Email` VARCHAR(50) NOT NULL,
  `address_id` SMALLINT(22) NOT NULL,
  `Date` DATETIME NOT NULL,
  `Last_Update` TIMESTAMP(1) NOT NULL,
  PRIMARY KEY (`idIMDb_UserID`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sakila`.`IMDB_USER_ADDRESS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`IMDB_USER_ADDRESS` ;

CREATE TABLE IF NOT EXISTS `sakila`.`IMDB_USER_ADDRESS` (
  ...
  CONSTRAINT `fk_address_city`
    FOREIGN KEY (`city_id`)
    REFERENCES `sakila`.`USER_City` (`city_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `sakila`.`staff` (
  ...
  CONSTRAINT `fk_staff_address`
    ...
    REFERENCES `sakila`.`IMDB_USER_ADDRESS` (`address_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sakila`.`USER_City`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`USER_City` ;

CREATE TABLE IF NOT EXISTS `sakila`.`USER_City` (
  ...
  CONSTRAINT `fk_city_country`
    ...
    REFERENCES `sakila`.`IMDb_country` (`IMDbcountry_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sakila`.`USER_ID_IMDb`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`USER_ID_IMDb` ;

CREATE TABLE IF NOT EXISTS `sakila`.`USER_ID_IMDb` (
